...
<head>
    ...
    <link rel="preload" href="{{ asset("layouts/adminlte/css/adminlte.css") }}" as="style" />
    ...
    <link rel="stylesheet" href="{{ asset("layouts/adminlte/css/adminlte.css") }}" />
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <img
                                        src="{{ asset("layouts/adminlte/img/user1-128x128.jpg") }}"
                                        alt="User Avatar"
...
<script src="{{ asset("layouts/adminlte/js/adminlte.js") }} ></script>
